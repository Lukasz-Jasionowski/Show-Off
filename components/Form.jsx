...
const Form = ({
    ...
    return (
        <section className='w-full max-w-full flex-start flex-col'>
            ...
            <p className="desc text-left max-w-md">{type} and share amazing posts with the world, brag about your ideas and progress.</p>
            <form
            ...
            >
                ...
                <label>
                    <span className='font-satoshi font-semibold text-base text-gray-700'>Tag<span className='font-normal'> (#product, #webdevelopment, #idea, #running)</span></span>
                    <input
                        value={post.tag}
